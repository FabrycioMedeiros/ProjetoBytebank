...
namespace ProjetoByteBank
{
    ...
    public class Program
    {
        ...
        static void ShowSubMenu()
        {
            ...
            Console.WriteLine("  3 - Efetuar transferência");
        ...
        static void MakeDeposit(List<string> cpfs, List<string> holders, List<string> passwords, List<double> balances)
        {
            Console.Write("Digite o cpf: ");
            string cpfTyped = Console.ReadLine();
            int indexFoundByCpf = cpfs.FindIndex(cpf => cpf == cpfTyped);
            Console.Write("Digite a senha: ");
            string passwordTyped = Console.ReadLine();
            ...
            {
                if (passwordTyped == passwords[indexFoundByCpf])
                {
                    Console.Write("Digite valor para depósito: ");
                    amount = double.Parse(Console.ReadLine());
                    balances[indexFoundByCpf] += amount;
                    Console.WriteLine($"Depósito realizado no valor de" +
                        $": {amount:F2}");
                    Console.WriteLine($"Saldo atual: {balances[indexFoundByCpf]:F2}");
                }
                else
                {
                    Console.WriteLine("Senha Inválida. Tente novamente ou mais tarde!");
                }
            }


        }
        static void MakeWithdrawal(List<string> cpfs, List<string> holders, List<string> passwords, List<double> balances)
        {
            Console.Write("Digite o cpf: ");
            string cpfTyped = Console.ReadLine();
            int indexFoundByCpf = cpfs.FindIndex(cpf => cpf == cpfTyped);
        ...
        static void MakeTransfer(List<string> cpfs, List<string> holders, List<string> passwords, List<double> balances)
        {
            Console.Write("Digite o cpf do usuário da conta para transferência: ");
            string cpfTyped = Console.ReadLine();
            int indexFoundByCpf = cpfs.FindIndex(cpf => cpf == cpfTyped);
            Console.Write("Digite a senha: ");
            string passwordTyped = Console.ReadLine();
            ...
            if (passwordTyped == passwords[indexFoundByCpf])
            {
                ...
                Console.Write("Digite o cpf da conta a ser destinada a transferência: ");
                ...
                else
                {
                    ...
                    Console.WriteLine($"Transferencia Realizada, saldo atual é de {amount:F2}");
                }
            }
            else
            {
        ...
        static void bankTransactions(List<string> cpfs, List<string> holders, List<string> passwords, List<double> balances)
        {
            ...
            do
            {
                ...
                {
                    case 1:
                        MakeDeposit(cpfs, holders, passwords, balances);
                        break;
                    case 2:
                        MakeWithdrawal(cpfs, holders, passwords, balances);
                        break;
                    case 3:
                        MakeTransfer(cpfs, holders, passwords, balances);
                        break;
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine("                         Bem vindo ao ByteBank Sharp Coders!");
            Console.WriteLine("  ==================================================================================");
            Console.WriteLine("  Para sua segurança, esteja com seus dados em mãos e não aceite ajuda de estranhos!");
            Console.WriteLine("          Antes de começarmos a utilização, vamos configurar alguns valores:");
            Console.WriteLine("  ==================================================================================");
            Console.WriteLine();
            ...
            do
            {
                ...
                {
                    case 0:
                        Console.WriteLine("Encerrando o programa, tenha um excelente dia...");
                        break;
                    case 1:
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        bankTransactions(cpfs, holders, passwords, balances);
                        break;
                }
